...
img = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, ".listing-grid .listing-item:nth-child(1) img"))
)
close_all_ad_tabs()
close_ads()
actions.move_to_element(img).pause(random.uniform(1, 3)).click(img).perform()
teardown()